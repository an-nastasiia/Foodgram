    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_subscribed', models.BooleanField(default=False, verbose_name='Подписан ли текущий пользователь на этого пользователя')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'author'), name='no_double_subscribe'),
        ),
        migrations.AddConstraint(
            model_name='subscription',
